...
*** Operations
Note that =nil= is the default value for each field of the =op= structure. For literate programming the source block name had to be 'ops' instead of 'op' in order to work with =:noweb=.
#+NAME: ops
#+BEGIN_SRC lisp
  (defstruct op
    "An operation."
...
#+BEGIN_SRC lisp :tangle gps-version-1.lisp :noweb yes
...
** GPS
#+NAME: gps 
#+BEGIN_SRC lisp :noweb yes :tangle gps.lisp
...
#+END_SRC
* TESTING CODE
#+BEGIN_SRC lisp :tangle gps-version-one-school-ops.lisp :noweb yes
<<school-ops>>
<<gps-version-one>>
#+END_SRC
* Appendix
...
: Files Generated: Mon Feb  6 13:00:20 2017
